...
// Allow missing encryption key during build time
function getEncryptionKey(): Buffer {
  if (!ENCRYPTION_KEY) {
    // During build time, we might not have the encryption key
    // This is only called when encryption functions are actually used
